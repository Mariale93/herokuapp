...
import co.com.choucair.certification.herokuapp.exceptions.Error;
...
import static co.com.choucair.certification.herokuapp.userinterface.SaveWindow.*;
...
public class HerokuApp {
    ...
    public void sheWillVerifyOnTheScreenTheMessageDatosGuardadosCorrectamente(String status) {
        theActorInTheSpotlight().should(seeThat(AnswerTo.myQuestion(status))
                .orComplainWith(Error.class,Error.REGIST_USER));
    }
